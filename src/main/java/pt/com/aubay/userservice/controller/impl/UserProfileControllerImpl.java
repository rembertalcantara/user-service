package pt.com.aubay.userservice.controller.impl;

import lombok.extern.slf4j.Slf4j;
import org.springframework.cache.annotation.CacheEvict;
import org.springframework.web.bind.annotation.*;
import pt.com.aubay.userservice.controller.UserProfileController;
...
public class UserProfileControllerImpl implements UserProfileController {
  ...
  public UserProfileControllerImpl(UserProfileClientService client) {
    this.client = client;
  }
